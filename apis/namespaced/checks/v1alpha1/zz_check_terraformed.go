...
func (mg *Check) GetTerraformResourceType() string {
	return "checkly_check"
}

// GetConnectionDetailsMapping for this Check
func (tr *Check) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"request[*].basic_auth[*].password": "request[*].basicAuth[*].passwordSecretRef", "request[*].headers": "request[*].headersSecretRef"}
}
...
func (tr *Check) LateInitialize(attrs []byte) (bool, error) {
	...
	opts = append(opts, resource.WithNameFilter("Request.FollowRedirects"))
