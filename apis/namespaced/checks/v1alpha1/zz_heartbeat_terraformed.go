...
// GetInitParameters of this Heartbeat
func (tr *Heartbeat) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Heartbeat
func (tr *Heartbeat) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
