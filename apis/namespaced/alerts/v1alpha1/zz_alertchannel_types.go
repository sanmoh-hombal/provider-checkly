...
type PagerdutyInitParameters struct {
	...
	// (String)
	ServiceKeySecretRef v1.LocalSecretKeySelector `json:"serviceKeySecretRef" tf:"-"`
...
type SMSInitParameters struct {
	...
	// (String) The mobile number to receive the alerts
	// The mobile number to receive the alerts
	NumberSecretRef v1.LocalSecretKeySelector `json:"numberSecretRef" tf:"-"`
}
...
type WebhookInitParameters struct {
	...
	// (String)
	WebhookSecretSecretRef *v1.LocalSecretKeySelector `json:"webhookSecretSecretRef,omitempty" tf:"-"`
