...
type StatusPageServiceParameters struct {
	...
	// +kubebuilder:validation:Optional
	StatusPageIDRef *v1.NamespacedReference `json:"statusPageIdRef,omitempty" tf:"-"`

	// Selector for a StatusPage in statuspage to populate statusPageId.
	// +kubebuilder:validation:Optional
	StatusPageIDSelector *v1.NamespacedSelector `json:"statusPageIdSelector,omitempty" tf:"-"`
}
