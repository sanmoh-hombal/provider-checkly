...
// ResolveReferences of this TriggerCheck.
func (mg *TriggerCheck) ResolveReferences(ctx context.Context, c client.Reader) error {
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &v1alpha1.CheckList{},
			Managed: &v1alpha1.Check{},
		},
	})
	if err != nil {
...
// ResolveReferences of this TriggerGroup.
func (mg *TriggerGroup) ResolveReferences(ctx context.Context, c client.Reader) error {
	r := reference.NewAPIResolver(c, mg)
	...
	rsp, err = r.Resolve(ctx, reference.ResolutionRequest{
		...
		To: reference.To{
			List:    &v1alpha1.CheckGroupList{},
			Managed: &v1alpha1.CheckGroup{},
		},
	})
	if err != nil {
