...
TCP port monitor with configurable thresholds.
...
| **Kind** | `TCPMonitor` |
| **Terraform Resource** | [`checkly_tcp_monitor`](https://registry.terraform.io/providers/checkly/checkly/latest/docs/resources/tcp_monitor) |
...
metadata:
  annotations:
    meta.upbound.io/example-id: checks/v1alpha1/tcpmonitor
  labels:
    testing.upbound.io/example-name: example-tcp-monitor
...
- See the [Terraform docs](https://registry.terraform.io/providers/checkly/checkly/latest/docs/resources/tcp_monitor) for detailed field descriptions.
