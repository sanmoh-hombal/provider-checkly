...
export TERRAFORM_PROVIDER_SOURCE       := checkly/checkly
export TERRAFORM_PROVIDER_REPO         := https://github.com/checkly/terraform-provider-checkly
...
xpkg.build.provider-checkly: do.build.images
